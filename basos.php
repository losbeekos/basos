<?php include('_header.php'); ?>
                ...
                <section>
                    <h1>Grid</h1>
                    <div class="grid">
                        <div class="column-12 column-omega" style="background: rgba(0,0,0,0.1)">column-12</div>
                    </div>
                    <div class="grid">
                        <div class="column-6" style="background: rgba(0,0,0,0.1)">column-6</div>
                        <div class="column-6 column-omega" style="background: rgba(0,0,0,0.1)">column-6</div>
                    </div>
                    <div class="grid">
                        <div class="column-4" style="background: rgba(0,0,0,0.1)">column-4</div>
                        <div class="column-8 column-omega" style="background: rgba(0,0,0,0.1)">column-8</div>
                    </div>
                    <div class="grid">
                        <div class="column-2" style="background: rgba(0,0,0,0.1)">column-2</div>
                        <div class="column-10 column-omega" style="background: rgba(0,0,0,0.1)">column-10</div>
                    </div>
                    <div class="grid">
                        <div class="column-7" style="background: rgba(0,0,0,0.1)">column-7</div>
                        <div class="column-5 column-omega" style="background: rgba(0,0,0,0.1)">column-5</div>
                    </div>
                    <div class="grid">
                        <div class="column-9" style="background: rgba(0,0,0,0.1)">column-9</div>
                        <div class="column-3 column-omega" style="background: rgba(0,0,0,0.1)">column-3</div>
                    </div>
                </section>
                ...
                <section>
                    <h1>Buttons</h1>
                    <h2>Alpha</h2>
                    <a class="btn-alpha btn-small" href="#">button small</a>
                    <a class="btn-alpha btn-medium" href="#">button medium</a>
                    <a class="btn-alpha btn-large" href="#">button large</a>
                    <input class="btn-alpha btn-large" value="button disabled" type="submit" disabled="disabled" />

                    <h2>Beta</h2>
                    <a class="btn-beta btn-small" href="#">button small</a>
                    <a class="btn-beta btn-medium" href="#">button medium</a>
                    <a class="btn-beta btn-large" href="#">button large</a>
                    <input class="btn-beta btn-large" value="button disabled" type="submit" disabled="disabled" />

                    <h2>Gamma</h2>
                    <a class="btn-gamma btn-small" href="#">button small</a>
                    <a class="btn-gamma btn-medium" href="#">button medium</a>
                    <a class="btn-gamma btn-large" href="#">button large</a>
                    <input class="btn-gamma btn-large" value="button disabled" type="submit" disabled="disabled" />

                    <h2>Delta</h2>
                    <a class="btn-delta btn-small" href="#">button small</a>
                    <a class="btn-delta btn-medium" href="#">button medium</a>
                    <a class="btn-delta btn-large" href="#">button large</a>
                    <input class="btn-delta btn-large" value="button disabled" type="submit" disabled="disabled" />

                    <h2>Epsilon</h2>
                    <a class="btn-epsilon btn-small" href="#">button small</a>
                    <a class="btn-epsilon btn-medium" href="#">button medium</a>
                    <a class="btn-epsilon btn-large" href="#">button large</a>
                    <input class="btn-epsilon btn-large" value="button disabled" type="submit" disabled="disabled" />

                    <h2>Block button</h2>
                    <div class="grid">
                        <div class="column-6">
                            <a class="btn-block btn-beta btn-large" href="#">block button</a>
                        </div>
                    ...
                    <form class="form form-validate" novalidate="novalidate">
                        <fieldset>
                            ...
                            <div class="form-row">
                                ...
                                <div class="column-7 column-omega form-data">Some data</div>
                            </div>
                            <div class="form-row">
                                <div class="column-5 form-label">
                                    <label>Form data</label>
                        ...
                        <div class="form-actions">
                            ...
                            <input class="btn-beta btn-medium" type="submit" value="verzenden" />
                        </div>
                    </form>
                </section>
                ...
                <section>
                    ...
                    <div class="btn-container">
                        ...
                        <a class="btn-alpha" href="#">3</a>
                        <a class="btn-alpha" href="#">4</a>
                        <a class="btn-alpha" href="#">5</a>
                        <a class="btn-divider">...</a>
                        <a class="btn-alpha" href="#">23</a>
                    ...
                    <div class="btn-container">
                        <ul class="btn-group btn-group-inline">
                            ...
                            <li><a class="btn-alpha" href="#">3</a></li>
                            <li><a class="btn-alpha" href="#">4</a></li>
                            <li><a class="btn-alpha" href="#">5</a></li>
                            <li><a class="btn-divider">...</a></li>
                            <li><a class="btn-alpha" href="#">23</a></li>
                            <li><a class="btn-alpha" href="#">&rsaquo;</a></li>
                        </ul>
                    </div>
                ...
                <section>
                    ...
                    <ul class="btn-group btn-group-inline">
                        ...
                        <li><a class="btn-alpha btn-small tooltip" data-tooltip-position="left" title="Kids don't turn rotten just from watching TV. Why not indeed! Yeah, I do that with my stupidness.">left</a></li>
                        <li><a class="btn-alpha btn-small tooltip" data-tooltip-position="top" title="Kids don't turn rotten just from watching TV. Why not indeed! Yeah, I do that with my stupidness." data-tooltip-trigger="click">click trigger</a></li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <ul class="btn-group btn-group-inline">
                        ...
                        <li><a class="btn-alpha btn-small modal-trigger" data-modal-id="modal-6">slide-left</a></li>
                    </ul>
                    <br />
        ...
        <div id="modal-1" class="modal" data-modal-effect="slip-top">
            <div class="modal-content">
                ...
                <a href="#" class="btn-beta btn-medium modal-close">Akkoord</a>
            </div>
        </div>
