    ...
    <div id="background" class="background">
            ...
            <div class="nav-bar__container">
                ...
                <nav class="nav-bar__nav">
                    ...
                    <ul class="nav-bar__list">
                        <li class="nav-bar__item"><a data-scrollspy-nav="grid" class="nav-bar__link" href="#grid" data-jumpto>grid</a></li>
                        <li class="nav-bar__item"><a data-scrollspy-nav="equalize" class="nav-bar__link" href="#equalize" data-jumpto>equalize</a></li>
                        <li class="nav-bar__item"><a data-scrollspy-nav="buttons" class="nav-bar__link" href="#buttons" data-jumpto>buttons</a></li>
                        <li class="nav-bar__item"><a data-scrollspy-nav="notifications" class="nav-bar__link" href="#notifications" data-jumpto>notifications</a></li>
                        <li class="nav-bar__item"><a data-scrollspy-nav="form" class="nav-bar__link" href="#form" data-jumpto>form</a></li>
                    </ul>
                </nav>
            </div>
        </header>
        ...
        <div id="container" class="off-canvas-push">
            ...
            <main id="main" role="main">
                ...
                <div class="section section--beta">
                    <div class="container">
                        ...
                        <ul class="section__list">
                            ...
                            <li>Delta</li>
                            <li>Epsilon</li>
                            <li>Add more in settings</li>
                        </ul>
                    </div>
                </div>

                <section id="grid" class="section section--alpha">
                    <div class="container">
                        <h1>Grid</h1>
                        <div class="grid">
                            <div class="column-12">
                ...
                <section id="notifications" class="section section--alpha">
                    <div class="container">
                        <h1>Notifications</h1>
                ...
                <section id="form" class="section section--alpha">
                    <div class="container">
                        <h1>Form</h1>
                ...
                <section id="tables" class="section section--alpha">
                    <div class="container">
                        <h1>Tables</h1>
                        <h2>Default table</h2>
                        <table class="table">
                ...
                <section id="pagination" class="section section--alpha">
                    <div class="container">
                        <h1>Pagination</h1>
                ...
                <section id="breacrumbs" class="section section--alpha">
                    <div class="container">
                        <h1>Breadcrumbs</h1>
                ...
                <section id="tabs" class="section section--alpha">
                    <div class="container">
                        <h1>Tabs</h1>
                        <ul class="tabs">
                ...
                <section id="media" class="section section--alpha">
                    <div class="container">
                        <h1>Media</h1>
                        <h2>Left</h2>
                ...
                <section id="pricingtables" class="section section--alpha">
                    <div class="container">
                ...
                <section id="modals" class="section section--alpha">
                    <div class="container">
                        <h1>Modals</h1>
                        <br />
                        ...
                        <ul class="btn-group btn-group--inline">
                            <li>
                                <a class="btn btn--alpha btn--small modal__trigger" data-modal-id="modal-1">slide-top</a>
                            ...
                            <li>
                                <a class="btn btn--alpha btn--small modal__trigger" data-modal-id="modal-2">slide-right</a>
                                <div id="modal-2" class="modal" data-modal-effect="slide-right">
                                    <div class="modal__content">
                            ...
                            <li>
                                <a class="btn btn--alpha btn--small modal__trigger" data-modal-id="modal-3">slide-bottom</a>
                                <div id="modal-3" class="modal" data-modal-effect="slide-bottom">
                                    <div class="modal__content">
                                        <h2>Dit is een titel</h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce convallis consectetur ligula. Morbi dapibus tellus a ipsum sollicitudin aliquet. Phasellus id est lacus. Pellentesque a elementum velit, a tempor nulla. Mauris mauris lectus, tincidunt et purus rhoncus, eleifend convallis turpis. Nunc ullamcorper bibendum diam, vitae tempus dolor hendrerit iaculis. Phasellus tellus elit, feugiat vel mi et, euismod varius augue. Nulla a porttitor sapien. Donec vestibulum ac nisl sed bibendum. Praesent neque ipsum, commodo eget venenatis vel, tempus sit amet ante. Curabitur vel odio eget urna dapibus imperdiet sit amet eget felis. Vestibulum eros velit, posuere a metus eget, aliquam euismod purus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
                                        <a href="#" class="btn btn--beta btn--medium" data-modal-close>Akkoord</a>
                            ...
                            <li>
                                <a class="btn btn--alpha btn--small modal__trigger" data-modal-id="modal-4">slide-left</a>
                                <div id="modal-4" class="modal" data-modal-effect="slide-left">
                                    <div class="modal__content">
                                        <h2>Dit is een titel</h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce convallis consectetur ligula. Morbi dapibus tellus a ipsum sollicitudin aliquet. Phasellus id est lacus. Pellentesque a elementum velit, a tempor nulla. Mauris mauris lectus, tincidunt et purus rhoncus, eleifend convallis turpis. Nunc ullamcorper bibendum diam, vitae tempus dolor hendrerit iaculis. Phasellus tellus elit, feugiat vel mi et, euismod varius augue. Nulla a porttitor sapien. Donec vestibulum ac nisl sed bibendum. Praesent neque ipsum, commodo eget venenatis vel, tempus sit amet ante. Curabitur vel odio eget urna dapibus imperdiet sit amet eget felis. Vestibulum eros velit, posuere a metus eget, aliquam euismod purus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
                                        <a href="#" class="btn btn--beta btn--medium" data-modal-close>Akkoord</a>
                        ...
                        <ul class="btn-group btn-group--inline">
                            <li>
                                <a class="btn btn--alpha btn--small modal__trigger" data-modal-id="modal-5">flip-horizontal</a>
                                <div id="modal-5" class="modal" data-modal-effect="flip-horizontal">
                                    <div class="modal__content">
                                        <h2>Dit is een titel 2</h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce convallis consectetur ligula. Morbi dapibus tellus a ipsum sollicitudin aliquet. Phasellus id est lacus. Pellentesque a elementum velit, a tempor nulla. Mauris mauris lectus, tincidunt et purus rhoncus, eleifend convallis turpis. Nunc ullamcorper bibendum diam, vitae tempus dolor hendrerit iaculis. Phasellus tellus elit, feugiat vel mi et, euismod varius augue. Nulla a porttitor sapien. Donec vestibulum ac nisl sed bibendum. Praesent neque ipsum, commodo eget venenatis vel, tempus sit amet ante. Curabitur vel odio eget urna dapibus imperdiet sit amet eget felis. Vestibulum eros velit, posuere a metus eget, aliquam euismod purus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
                                        <a href="#" class="btn btn--beta btn--medium" data-modal-close>Akkoord</a>
                            ...
                            <li>
                                <a class="btn btn--alpha btn--small modal__trigger" data-modal-id="modal-6">flip-vertical</a>
                                <div id="modal-6" class="modal" data-modal-effect="flip-vertical">
                                    <div class="modal__content">
                                        <h2>Dit is een titel 2</h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce convallis consectetur ligula. Morbi dapibus tellus a ipsum sollicitudin aliquet. Phasellus id est lacus. Pellentesque a elementum velit, a tempor nulla. Mauris mauris lectus, tincidunt et purus rhoncus, eleifend convallis turpis. Nunc ullamcorper bibendum diam, vitae tempus dolor hendrerit iaculis. Phasellus tellus elit, feugiat vel mi et, euismod varius augue. Nulla a porttitor sapien. Donec vestibulum ac nisl sed bibendum. Praesent neque ipsum, commodo eget venenatis vel, tempus sit amet ante. Curabitur vel odio eget urna dapibus imperdiet sit amet eget felis. Vestibulum eros velit, posuere a metus eget, aliquam euismod purus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
                                        <a href="#" class="btn btn--beta btn--medium" data-modal-close>Akkoord</a>
                        ...
                        <ul class="btn-group btn-group--inline">
                            <li>
                                <a class="btn btn--alpha btn--small modal__trigger" data-modal-id="modal-7">fadescale</a>
                                <div id="modal-7" class="modal" data-modal-effect="fadescale">
                                    <div class="modal__content">
                                        <h2>Dit is een titel 2</h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce convallis consectetur ligula. Morbi dapibus tellus a ipsum sollicitudin aliquet. Phasellus id est lacus. Pellentesque a elementum velit, a tempor nulla. Mauris mauris lectus, tincidunt et purus rhoncus, eleifend convallis turpis. Nunc ullamcorper bibendum diam, vitae tempus dolor hendrerit iaculis. Phasellus tellus elit, feugiat vel mi et, euismod varius augue. Nulla a porttitor sapien. Donec vestibulum ac nisl sed bibendum. Praesent neque ipsum, commodo eget venenatis vel, tempus sit amet ante. Curabitur vel odio eget urna dapibus imperdiet sit amet eget felis. Vestibulum eros velit, posuere a metus eget, aliquam euismod purus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
                                        <a href="#" class="btn btn--beta btn--medium" data-modal-close>Akkoord</a>
                            ...
                            <li>
                                <a class="btn btn--alpha btn--small modal__trigger" data-modal-id="modal-8">superscaled</a>
                                <div id="modal-8" class="modal" data-modal-effect="superscale">
                                    <div class="modal__content">
                                        <h2>Dit is een titel 2</h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce convallis consectetur ligula. Morbi dapibus tellus a ipsum sollicitudin aliquet. Phasellus id est lacus. Pellentesque a elementum velit, a tempor nulla. Mauris mauris lectus, tincidunt et purus rhoncus, eleifend convallis turpis. Nunc ullamcorper bibendum diam, vitae tempus dolor hendrerit iaculis. Phasellus tellus elit, feugiat vel mi et, euismod varius augue. Nulla a porttitor sapien. Donec vestibulum ac nisl sed bibendum. Praesent neque ipsum, commodo eget venenatis vel, tempus sit amet ante. Curabitur vel odio eget urna dapibus imperdiet sit amet eget felis. Vestibulum eros velit, posuere a metus eget, aliquam euismod purus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
                                        <a href="#" class="btn btn--beta btn--medium" data-modal-close>Akkoord</a>
                ...
                <section id="accordion" class="section section--alpha">
                    <div class="container">
                        <h1>Accordion</h1>
                        <div class="accordion">
                ...
                <section id="scrollspy" class="section section--alpha">
                    <div class="container">
                        ...
                        <div class="grid" data-equalize>
                            <div data-equalize-target data-scrollspy data-scrollspy-class="animation-fadeInRotateAlpha" class="column-3 block">Now Fry, it's been a few years since medical school, so remind me. Disemboweling in your species: fatal or non-fatal? I've been there. My folks were always on me to groom myself and wear underpants. What am I, the pope? Who am I making this out to? No! Don't jump! Bender, we're trying our best.</div>
                            <div data-equalize-target data-scrollspy data-scrollspy-class="animation-fadeInRotateGamma" data-scrollspy-delay="200" class="column-3 block">Now Fry, it's been a few years since medical school, so remind me. Disemboweling in your species: fatal or non-fatal? I've been there. My folks were always on me to groom myself and wear underpants. What am I, the pope? Who am I making this out to? No! Don't jump! Bender, we're trying our best.</div>
                            <div data-equalize-target data-scrollspy data-scrollspy-class="animation-fadeInRotateBeta" data-scrollspy-delay="400" class="column-3 block">Now Fry, it's been a few years since medical school, so remind me. Disemboweling in your species: fatal or non-fatal? I've been there. My folks were always on me to groom myself and wear underpants. What am I, the pope? Who am I making this out to? No! Don't jump! Bender, we're trying our best.</div>
                            <div data-equalize-target data-scrollspy data-scrollspy-class="animation-fadeInRotateEpsilon" data-scrollspy-delay="600" class="column-3 block">Now Fry, it's been a few years since medical school, so remind me. Disemboweling in your species: fatal or non-fatal? I've been there. My folks were always on me to groom myself and wear underpants. What am I, the pope? Who am I making this out to? No! Don't jump! Bender, we're trying our best.</div>
                        </div>
                    </div>
                </section>

                <section id="parallax" class="section section--alpha">
                    <div class="container">
                        <h1>Parallax</h1>
                        <div class="grid">
                            <div class="column-12">
                ...
                <section id="thumbnail-grid" class="section section--alpha">
                    <div class="container">
                        ...
                        <div class="thumbnail-grid">
                            <a class="thumbnail-grid__item" href="#" data-scrollspy data-scrollspy-class="animation-fadeIn">
